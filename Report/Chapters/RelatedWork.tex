...
In contrast to the previous paper by Kumar \textit{et al}\ref{heterogeneous-ee}, this experiment assigned multiple threads for multiple cores, and best global assignment was considered above best assignment for a selected application.
...
This can be seen in \todo{Didn't show result figure from previous paper, consider if this leads to inconsistency.}figure \ref{fig:Kumar2}.
\todo{Following 2 sentences are nearly ripoff from \ref{heterogeneous-perf, consider making quote or what?}}Compared to 4 EV6 cores, the heterogeneous processor performed up to 37\% better with an average 26\% improvement over the configuration considering 1-20 threads. 
