...
\todo{Turbo Amber should have been described at this point. Suggest removing this repeat}The new tile is derived from the existing Turbo Amber tile for SHMAC, the Turbo Amber tile, which contains
...
and the required tile interfaces and router module.\todo{Consider adding this to figure?}
