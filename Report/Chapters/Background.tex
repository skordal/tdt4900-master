...
\textbf{Scaling down to 28 nm mentioned. Find and compare with current lowest.}
The question remains whether Bitcoin chips will scale well, even further.
The Dark Silicon problem will require improvement in energy efficiency at about 1.4 times per proess generation.
