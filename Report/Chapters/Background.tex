...
\todo{Couldn't find a better way to state this without making it look like the source material. Have a look at it before deadline}The notion of general-purpose computation is fragmented, and the former clear lines of lines of communication between programmers and software and the underlying hardware is eliminated.
