...
\todo{Must have cryptography and SHA-2 / SHA-256 described before this point, in order for the CPU-chapter to make sense.}
...
This buffer contains the beginning portion of the block header that precedes the nonce, and has the \todo{Make sure this constant intermadiate hash value is described earlier (SHA-256 description)}constant intermediate hash value.
...
%Input parameters were tweaked as well, such as thread numbers, to balance maximum throughput with stability and temperature limits.
