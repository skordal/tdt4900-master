...
entity arbiterTop is
	...
	port(
		...
		adrOut : out std_logic_vector(n+b-1 downto 0);
...
architecture top of arbiterTop is
	...
	signal adrOpt : std_logic_vector(b-1 downto 0); 
	...
	-- Control signals to arbiter dataMux and adrMux
		...
		adrOpt : out std_logic_vector(b-1 downto 0)	
		);
	end component;

	component adrMux
	port(
		opt: in std_logic_vector(b-1 downto 0);
		interruptInput: in std_logic_vector(n+b-1 downto 0);
		storeInput0: in std_logic_vector(n+b-1 downto 0);
		storeInput1: in std_logic_vector(n+b-1 downto 0);
		loadInput0: in std_logic_vector(n+b-1 downto 0);
